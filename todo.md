...
- [ ] Otimização de SEO e Meta Tags avançadas.
- [ ] Revisar menu 3D se a estabilidade do R3F permitir no futuro.

## Notas Técnicas
- **Stack:** Next.js 16 (Turbopack), Tailwind CSS, Framer Motion.
- **Repositório:** `https://github.com/MateusJuni0/restauranteAvilez`
