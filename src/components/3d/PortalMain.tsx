...
import { Text, ScrollControls, Scroll, useScroll, Float } from '@react-three/drei'
...
export default function PortalMain() {
  return (
    <Canvas
      ...
      style={{ height: '100vh', width: '100vw', background: '#000', position: 'fixed', top: 0, left: 0, zIndex: -1 }}
    >
